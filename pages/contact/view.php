                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div style="padding: 0 10px;text-align:justify"> 
                            ...
                            <p><i style="margin-right:10px" class="fa fa-map-marker"></i>Crowne Plaza San Salvador, El Salvador</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-phone"></i>+503 2250-000</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
